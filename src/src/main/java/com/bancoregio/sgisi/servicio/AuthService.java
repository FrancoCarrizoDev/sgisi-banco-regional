...
public class AuthService {
    ...
    public AuthService(UsuarioDAO usuarioDAO){ this.usuarioDAO=usuarioDAO; }
    /** Autentica usuario por email y password plano. */
    public Usuario autenticar(String email, String plainPassword) throws SQLException { return usuarioDAO.buscarActivoPorEmailYHash(email, HashUtil.sha256(plainPassword)).orElse(null); }
}
